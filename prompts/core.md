...
You can embed images, audio, and video in your responses using standard markdown
image syntax with data URIs (e.g. `![description](data:image/png;base64,...)`).
Use this to show generated images, charts, QR codes, or other visual assets.
